                        ...
                        <div class="col-md-10">
                          ...
                          <div class="input-group">
                            <select class="form-control col-md-3" v-model="opcion">
                              <option value="servidores.nombre">Servidor</option>
                              <option value="servidores.descripcion">Descripcion</option>
                              <option value="servidores.ip">IP</option>
                            </select>
                            <input
                              type="text"
                              class="form-control"
...
export default {
  data() {
    return {
      ...
      activarValidate: "",
      mensaje: "",
      opcion: "servidores.nombre",
      nombre_vista: "Servidor"
    };
  },
  mounted() {
    this.listar(1, "");
  ...
  methods: {
    ...
    validar() {
      if (!this.nombre) {
        this.mensaje = "Ingrese el Nombre del Servidor";
        return true;
      }
      if (!this.ip) {
      ...
      if (!this.password) {
        this.mensaje = "Ingrese el Password";
        return true;
      }
      if (!this.descripcion) {
